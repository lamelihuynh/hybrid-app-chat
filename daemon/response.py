...
#                "Cookie": "{}".format(reqhdr.get("Cookie", "sessionid=xyz789")), #dummy cooki
    ...
    def build_response(self, request):
        ...
        try:
            ...
            # Nếu prepare_content_type không hỗ trợ MIME type này, trả về 404
        ...
        if c_len == 0:
            # Nếu không tìm thấy file trong build_content, trả về 404
            return self.build_notfound()
    ...
    def build_app (self, request, data): 
        """
        Builds a full HTTP response for JSON data from an API endpoint.

        :params request (class:`Request <Request>`): incoming request object.
        :params data (dict): The dictionary data to be sent as JSON.

        :rtype bytes: complete HTTP response with JSON content.
        """
        
        if data is None:
            data = {}
        json_content = json.dumps(data)
        self._content = json_content.encode('utf-8') 
